		...
		},
		{
			...
			operations: [
				...
				},
				{
					...
					example: 'o growth_boundary\n#@source: procedural\n#@type: curve\n#@params: points=[[-0.75,-0.28,0],[0.75,-0.28,0],[0.75,0.28,0],[-0.75,0.28,0]]\n#@transform: position=[0,0,0],rotation=[0,0,0],scale=[1,1,1]\n\no growth_column\n#@source: simulation\n#@sim: differential_growth_stack\n#@params: mode=infill, growth_solver=node, contour=growth_boundary, profile=circle, radius=0.12, boundary_margin=0.02, target_spacing=0.034, nodes_start=10, max_nodes=500, max_speed=0.0055, max_force=0.0068, min_separation=0.05, neighbor_dist=0.12, separate_weight=1.5, cohesion_weight=0.25, max_edge_length=0.038, boundary_clearance=0.014, boundary_weight=1.2, show_seed_section=true, progressive=true, curve_points=160, steps=420, sample_every=10, height=0.5, jitter=0.0, seed_smooth=1, section_smooth=1, thickness=0.0, tube_segments=8, loft=true, show_sections=false, seed=4\n#@ops:\n#@ - smooth iterations=1 strength=0.10'
				},
				{
					name: 'boids',
					category: 'Simulations',
